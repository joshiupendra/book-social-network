package com.seemay.book.book;

import com.seemay.book.common.PageResponse;
import com.seemay.book.exception.OperationNotPermittedException;
import com.seemay.book.file.FileStorageService;
import com.seemay.book.history.BookTransactionHistory;
import com.seemay.book.history.BookTransactionHistoryRepository;
...
import static com.seemay.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        // Check if Book is shareable and not archived
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("The requested book cannot be borrowed since it is an archived or not shareable");
        }

        // User can't borrow it's his own book
        User user = ((User) connectedUser.getPrincipal());
        if (Objects.equals(book.getOwner().getId(), user.getId())) {
        ...
        if (isAlreadyBorrowed) {
            throw new OperationNotPermittedException("You requested book is already borrowed");
        }
