...
import { findBookBiId } from '../fn/book/find-book-bi-id';
import { FindBookBiId$Params } from '../fn/book/find-book-bi-id';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findBookBiId()` */
  static readonly FindBookBiIdPath = '/books/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findBookBiId()` instead.
   *
   * This method doesn't expect any request body.
   */
  findBookBiId$Response(params: FindBookBiId$Params, context?: HttpContext): Observable<StrictHttpResponse<BookResponse>> {
    return findBookBiId(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findBookBiId$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findBookBiId(params: FindBookBiId$Params, context?: HttpContext): Observable<BookResponse> {
    return this.findBookBiId$Response(params, context).pipe(
